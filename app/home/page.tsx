...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
            <main className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 space-y-8">
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col space-y-4">
                        {session ? (
                            ...
                            <button onClick={handleSignIn} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition duration-150 ease-in-out flex items-center justify-center">
